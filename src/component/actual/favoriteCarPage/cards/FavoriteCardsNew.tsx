...
// import FavoriteIcon from '@mui/icons-material/RemoveRoad';
import FavoriteIcon from '@mui/icons-material/Favorite';
import { CircularProgress, Slide } from '@mui/material';
import { driverTypeStr, logoFind, numberWithSpaces } from '../../allNewCarPage/servicesNewCar/service';

import { LogoList, carBodyImgChange, gearBoxName } from '../../../../services/functions';
...
function FavoriteCarsNew({ setShowModal, setFavArr, favArr, setFavArrUsed, favArrUsed, refCards }: Props) {
  ...
  //удаление с пробегом 
  async function deleteToFavoriteUsed(id) {
  ...
  return (
    <>
      <div className='divTitle'>
        ...
        Ваши авто <span id="sum">
          <CountUp start={0} end={favArr.length + favArrUsed.length} duration={1.5} separator=" " suffix="  шт" />
        </span>
      </div>
      <div className='background' ref={refCards}>
        {favArr !== null || favArrUsed !== null ?
          (<>
...
export default FavoriteCarsNew