      ...
      <div className='background'>
        ...
        <div className='cards' id="desktop">
          ...
          <div className='descBrand'>
            <div className='titleBrand'>О BAIC</div>
            <div className='txtBrand'>
              BAIC - это бренд, вдохновленный смелостью, инновациями и стремлением к превосходству.
              Всяческая деталь их автомобилей
              является выразителем эстетики и технической изысканности, на каждом шагу они стремятся к совершенству.
            </div>
            <div className='rowColumn'>
              ...
              <div className='columnBrand'>
                <div className='titleBrand'>
                  <span id="titleMap">BAIC Арконт</span>
                </div>
                <div className="descBrand">
                  <a className='href_a' href="tel:+78442204150">+7 (844) 220-41-50</a>
                </div>
                <div className="descBrand">
                ...
                <div className="descBrand">
                  <a className='href_a' href="mailto:baic@arkont.ru">baic@arkont.ru</a>
                </div>
                <div className="descBrand">
            ...
            <div className="descBrand" id='deskMap'>
              <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A790d51cca41cacb371a72350bef338f9172fe0e13003b637ee757b26308eaf48&amp;source=constructor" width="100%" height="250" frameBorder="0"></iframe>
            </div>
            <div className="descBrand" id='mobMap'>
              <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A790d51cca41cacb371a72350bef338f9172fe0e13003b637ee757b26308eaf48&amp;source=constructor" width="100%" height="350" frameBorder="0"></iframe>
            </div>
          </div>
        </div>
      </div >
