...
import news1 from '/public/images/catalogPages/kaiyi/news/1.png'
import news2 from '/public/images/catalogPages/kaiyi/news/2.png'
        ...
        <div className='cards' id="desktop">
          ...
          <div className='descBrand'>
            ...
            <div className='txtBrand'>
              Представляем вам воплощен
              ие элегантности и электромобильной революции - седан KAIYI E5.
              Этот изысканный автомобиль объединяет в себе современный дизайн,
              передовые технологии и высокую эффективность.
            </div>
