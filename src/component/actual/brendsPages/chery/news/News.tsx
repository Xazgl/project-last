...
import news1 from '/public/images/catalogPages/chery/news/1.webp'
import news2 from '/public/images/catalogPages/chery/news/1.jpg'
        ...
        <div className='cards' id="desktop">
          ...
          <div className='descBrand'>
            ...
            <div className='txtBrand'>
              Абсолютно новый Chery Arrizo 8 - Эффектный силуэт кузова и
              мощные мускулистые линии, словно визуальное выражение динамики,
              создают ощущение энергии и неудержимой жизненной силы.
            </div>
