...
function CarUsedSidebarMobile({ cars, setFilteredCars, filteredCars }: Props) {
                ...
                >
                    ...
                    <AccordionDetails sx={{ backgroundColor: '#efe9e9', width: '100%' }}>
                        ...
                        <div className="rowSideBar" id="column" >
                            <Button
                                variant="outlined"
                                sx={{ width: '100%', fontSize: '12px', height: '40px', fontFamily: 'Roboto',backgroundColor:'white' }}
...
export default CarUsedSidebarMobile