                    ...
                    <AccordionDetails sx={{ backgroundColor: '#f2f2f2', width: '100%' }}>
                                            ...
                                            <FormControlLabel
                                                ...
                                                control={
                                                    <Checkbox color={'default'}
                                                        checked={currentFilter.gearBoxName?.includes(gearBox)}
                                                    />
                                                }
                                            ...
                                            {filteblackProps.driverTypes.map(driver =>
                                                <FormControlLabel
                                                    ...
                                                    control={
                                                        <Checkbox
                                                            color={'default'}
                                                            checked={currentFilter.driverTypeName?.includes(driver)} />
                                                    }
                                        ...
                                        {filteblackProps.engineTypes.map(engine =>
                                            <FormControlLabel
                                                ...
                                                control={
                                                    <Checkbox
                                                        color={'default'}
                                                        checked={currentFilter.engineTypeName?.includes(engine)}
                                                    />
                                                }
                        ...
                        <div className="rowSideBar" id="column" >
                            <Button
                                variant="outlined"
                                sx={{
                                    width: '100%', fontSize: '12px', height: '40px', fontFamily: 'Gilroy', backgroundColor: 'white', color: ' #131313',
                                }}
