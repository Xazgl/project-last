...
import banner from '/public/images/catalogPages/hyundai/bannerDesktop.png'
...
export function HyundaiImgDestop() {
    ...
    return (
        <>
            <div className="background">
                ...
                <div className='title'>
                    <span>
                        <AnimatedText text={` Каталог Hyundai в   `} interval={100} />
