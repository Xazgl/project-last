...
import bannerDc from '/public/images/catalogPages/hyundai/dc.png'
      ...
      <div className='background'>
        ...
        <div className='cards' id="desktop">
          ...
          <div className='descBrand'>
            <div className='titleBrand'>О Hyundai</div>
            <div className='txtBrand'>
              Hyundai - это бренд, который олицетворяет инновации, стиль и
              надежность. Каждая модель Hyundai является совершенным сочетанием
              современного дизайна, передовых технологий и высокой функциональности.            </div>
            <div className='rowColumn'>
              ...
              <div className='columnBrand'>
                <div className='titleBrand'>
                  <span id="titleMap">Hyundai Арконт</span>
                </div>
                <div className="descBrand">
                  <a className='href_a' href="tel:+78443445107">+7 (8443) 44-51-07</a>
                </div>
                <div className="descBrand">
                  г. Волжский, пр-т Ленина, 359
                </div>
                <div className="descBrand">
                  <a className='href_a' href="mailto:hyundai@arkont.ru">hyundai@arkont.ru</a>
                </div>
                <div className="descBrand">
                  <Link href="https://yandex.ru/maps/38/volgograd/?from=&ll=44.516979%2C48.707068&mode=routes&rtext=~48.757240%2C44.790844&rtt=mt&ruri=~ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgoxNjI4MzMwMzI5EnjQoNC-0YHRgdC40Y8sINCS0L7Qu9Cz0L7Qs9GA0LDQtNGB0LrQsNGPINC-0LHQu9Cw0YHRgtGMLCDQktC-0LvQttGB0LrQuNC5LCDQv9GA0L7RgdC_0LXQutGCINC40LzQtdC90Lgg0JvQtdC90LjQvdCwLCAzNTkiCg3UKTNCFWoHQ0I%2C&source=wizroute&z=12">
                    <a rel="noopener noreferrer">
            ...
            <div className="descBrand" id='deskMap'>
              <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ac0bb2e4bbea3eda65ae9e8aa759ff967aaece10f97c8a220e480d62424245994&amp;source=constructor" width="100%" height="250" frameBorder="0"></iframe>
            </div>
            <div className="descBrand" id='mobMap'>
              <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ac0bb2e4bbea3eda65ae9e8aa759ff967aaece10f97c8a220e480d62424245994&amp;source=constructor" width="100%" height="350" frameBorder="0"></iframe>
            </div>
          </div>
        </div>
      </div >
