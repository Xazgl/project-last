...
import bannerDc from '/public/images/catalogPages/kia/dc.png'
      ...
      <div className='background'>
        ...
        <div className='cards' id="desktop">
          ...
          <div className='descBrand'>
            <div className='titleBrand'>О KIA</div>
            <div className='txtBrand'>
              KIA - это бренд, который воплощает динамичность, элегантность и
              непревзойденное качество. Каждая модель KIA обладает харизмой,
            ...
            <div className='rowColumn'>
              ...
              <div className='columnBrand'>
                <div className='titleBrand'>
                  <span id="titleMap">KIA Арконт</span>
                </div>
                <div className="descBrand">
                ...
                <div className="descBrand">
                  <a className='href_a' href="mailto:kia@arkont.ru">kia@arkont.ru</a>
                </div>
                <div className="descBrand">
