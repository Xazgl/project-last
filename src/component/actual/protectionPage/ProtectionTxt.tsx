                    ...
                    <ul>Политика по охране труда и результаты спец. оценки рабочих мест:
                        ...
                        <li>
                            <Accordion>
                                ...
                                >
                                    <Typography sx={{ fontWeight: 'bold' ,fontFamily: 'Gilroy'}}>ООО «Арконт ВВ»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold' ,fontFamily: 'Gilroy'}}>ООО «Арконт Д»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold' ,fontFamily: 'Gilroy'}}>ООО «Арконт М»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold' ,fontFamily: 'Gilroy'}}>ООО «Арконт Р»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold' ,fontFamily: 'Gilroy'}}>ООО «Арконт Шина»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold',fontFamily: 'Gilroy' }}>ООО «Арконт ЯРЛ»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold',fontFamily: 'Gilroy' }}>ООО «Концепт СТ»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
                        ...
                        <li>
                            <Accordion>
                                <AccordionSummary
                                    ...
                                    sx={{ backgroundColor: '#3d3d3d', color: 'white' }}
                                >
                                    <Typography sx={{ fontWeight: 'bold',fontFamily: 'Gilroy'}}>ООО «Арконт В»</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <ul>
