...
import { TableUsedCars } from "../../../src/component/admin/TableUsedCars"
            ...
            <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
              ...
              >
                <Typography sx={{ width: '33%', flexShrink: 0, fontFamily: 'TacticSans-Reg' }}>
                  Таблица с пробегом + снять с продажи + добавить
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  <TableUsedCars setCarImg={setCarImg} showModal={showModal} setShowModal={setShowModal} />
                </Typography>
              </AccordionDetails>
            </Accordion>
          </div>
