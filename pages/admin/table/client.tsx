...
import { CircularProgress, Collapse, List, ListItemButton, ListItemIcon, ListItemText, ListSubheader, Typography } from "@mui/material"
            ...
            <Accordion expanded={expanded === 'panel15'} onChange={handleChange('panel15')}>
              ...
              >
                <Typography sx={{ width: '33%', flexShrink: 0, fontFamily: 'TacticSans-Reg' }}>
                  Таблица Клиенты обратный звонок
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
