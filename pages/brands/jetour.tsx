...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/jetour/NewCarComponent'
import { JetourImgDestop } from '../../src/component/actual/brendsPages/jetour/banner/JetourImg'
...
const JetourPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР JETOUR</title>
