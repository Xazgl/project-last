...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/jac/NewCarComponent'
import { JacImgDestop } from '../../src/component/actual/brendsPages/jac/banner/JacImg'
...
const JacPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР JAC</title>
