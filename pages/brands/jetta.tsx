...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/jetta/NewCarComponent'
import { JettaImgDestop } from '../../src/component/actual/brendsPages/jetta/banner/JettaImg'
...
const JettaPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР JETTA</title>
