...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/kia/NewCarComponent'
import { ExeedImgDestop } from '../../src/component/actual/brendsPages/exeed/banner/ExeedImg'
import { HyundaiImgDestop } from '../../src/component/actual/brendsPages/hyundai/banner/HyundaiImg'
import { KiaImgDestop } from '../../src/component/actual/brendsPages/kia/banner/KiaImg'
...
const KiaPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР KIA</title>
