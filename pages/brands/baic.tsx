...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/kaiyi/NewCarComponent'
import { BaicImgDesktop } from '../../src/component/actual/brendsPages/baic/banner/BaicImg'
...
const BaicPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР BAIC</title>
