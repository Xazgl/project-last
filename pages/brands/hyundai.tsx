...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/hyundai/NewCarComponent'
...
const HyundaiPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР Hyundai</title>
