...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/uaz/NewCarComponent'
import { UazImgDestop } from '../../src/component/actual/brendsPages/uaz/banner/UazImg'
...
const UazPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР УАЗ</title>
