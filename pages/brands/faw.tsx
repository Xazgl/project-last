...
import { FilterWithPageComponent } from '../../src/component/actual/brendsPages/faw/NewCarComponent'
import { FawImgDestop } from '../../src/component/actual/brendsPages/faw/banner/FawImg'
...
const FawPage: NextPage<{ cars: AllCarDto, brands: Brand[] }> = ({ cars, brands }) => {
  ...
  return (
    <>
      <Head>
        <title>АРКОНТ ОФИЦИАЛЬНЫЙ ДИЛЕР FAW</title>
